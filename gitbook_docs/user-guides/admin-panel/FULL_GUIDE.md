...
**Geomatching:**
The system uses Haversine formula to match customer-selected locations to fixed routes within the configured radius tolerance.
...
**Location:** Separate Streamlit application at `/backend/dashboard/sales_report.py`

**Note:** This is not part of Django Admin but a standalone analytics dashboard.
