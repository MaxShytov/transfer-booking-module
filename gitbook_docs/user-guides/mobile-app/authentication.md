...
Learn how to access your 8Move Transfer account through the mobile application.
...
If you don't have an account yet, tap **"Don't have an account? Register"** at the bottom of the login screen to create a new account.
