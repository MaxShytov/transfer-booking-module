...
**Customers** - Learn how to book transfers using the mobile app

**Drivers** - Understand booking details and customer requirements

**Operations Managers** - Configure pricing, manage bookings, and monitor performance

**Administrators** - Set up the system, manage users, and configure routes

**Business Owners** - Understand the pricing model and analytics capabilities
...
1. [What is 8Move Transfer](getting-started/what-is-8move-transfer.md) - Learn about the system
2. [Key Features](getting-started/key-features.md) - Explore capabilities
